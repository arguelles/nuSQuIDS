...
plot "fluxes_flavor.txt" u 1:($5) w l ls 1 title "Muon LV"
replot "fluxes_flavor.txt" u 1:($6) w l ls 2 title "Muon noLV"
replot "fluxes_flavor.txt" u 1:($7) w l ls 3 title "Tau LV"
replot "fluxes_flavor.txt" u 1:($8) w l ls 4 title "Tau noLV"
