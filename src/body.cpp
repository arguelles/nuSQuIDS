...
double EarthAtm::density(const GenericTrack& track_input) const
{
  ...
  if ( rel_r < x_radius_min ){
    ...
    double h = earth_with_atm_radius*(rel_r - radius/earth_with_atm_radius); // un-normalized rel_r by multiplying by the total earth_with_atm_radius in km to get height above surface
