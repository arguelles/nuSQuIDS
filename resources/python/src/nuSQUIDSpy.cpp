...
BOOST_PYTHON_MODULE(nuSQUIDSpy)
{
  ...
  class_<nuSQUIDSAtm<>, boost::noncopyable, std::shared_ptr<nuSQUIDSAtm<>> >("nuSQUIDSAtm", no_init)
    ...
    .def(init<std::shared_ptr<EarthAtm>,marray<double,1>,marray<double,1>,unsigned int,NeutrinoType>(args("earthatm", "CosZenith_vector","E_vector","numneu","NT")))
    .def(init<std::shared_ptr<EarthAtm>,marray<double,1>,marray<double,1>,unsigned int,NeutrinoType,bool>(args("earthatm","CosZenith_vector","E_vector","numneu","NT","iinteraction")))
    .def(init<std::shared_ptr<EarthAtm>,marray<double,1>,marray<double,1>,unsigned int,NeutrinoType,bool,std::shared_ptr<NeutrinoCrossSections>>(args("earthatm","CosZenith_vector","E_vector","numneu","NT","iinteraction","ncs")))
    .def(init<std::string>(args("filename")))
