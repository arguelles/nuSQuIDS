...
this regime, generalized functions for the analytic evolution are included in
SQuIDS~\cite{SQUIDS} versions 1.2 and later. 
...
larger than the value given by {\ttf scale} the trigonometric evaluations are set to zero. 
...
In \ref{sec:code} the functions to evaluate the the expectation values for the neutrinos, {\ttf EvalFlavor} in
...
As noted in the previous poin,t the issue of fast oscillations and the localization of the neutrino emission is related. 
