...
A unique feature of {\ttg nuSQuIDS} is that it solves the neutrino oscillation problem over a grid of energies;
...
Matrix diagonalization is frequently used for coherent effects (e.g. neutrino oscillation) in uniform media, for which the system of differential equations can be written down and solved analytically, as introduced in \cite{barger1980matter}. 
