...
However, none of the above mentioned packages are able to simultaneously take into account 
...
Additionally, the paper contains an extended appendix that provides
further useful information of the code. This appendix is arranged 
as follows. In section~\ref{sec:tests} we describe the unit tests that
are provided with the library; in section~\ref{sec:code} we describe
the main classes and structure of the code; and finally, in section~\ref{sec:python}
...
Neutrino oscillations can be computed for up to six neutrino flavors out of the box, though it can be extended to an arbitrary number of
